...
| 慢速轮询 | 300s | 硬件告警（GPU温度/内存）、日志 E/F 级别、日常播报（1h 间隔） |
...
*测试环境：{your_machine} · AMD Ryzen AI Max+ 395 · 128 GB · llama.cpp b9692 Vulkan · 2026-06-03 · 更新于 2026-06-19（单模型模式，cache-ram 49152/65536，Hermes v0.16.0，超时 7200s，TTS + 监控播报已上线）*
