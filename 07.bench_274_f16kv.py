#!/usr/bin/env python3
"""07.bench_274_f16kv.py — 27B Dense Q4 F16 KV full context benchmark.

Tests 274 (27B Dense Q4) at p128/p4K/p32K/p64K/p128K/p256K.
F16 KV cache, UB=1024.

Usage (on inference machine):
    LLM_BASE_DIR=/home/zxw LLM_API_KEY=xxx python3 -u 07.bench_274_f16kv.py
"""
...
CSV_FILE = os.path.join(_BASE_DIR, "test/bench_274_f16kv.csv")
...
def main():
    print("=" * 64)
    print("  27B Dense Q4 — F16 KV Full Context Benchmark")
