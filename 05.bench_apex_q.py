...
Usage:
    LLM_BASE_DIR=/home/zxw LLM_API_KEY=xxx python3 -u 05.bench_apex_q.py
    python3 -u 05.bench_apex_q.py --ub 256
"""
...
def main():
    ...
    print("=" * 64)
    print("  APEX I-Quality (21.9GB) — Full Benchmark")
    ...
    try:
        for kv, ub in run_plan:
            ...
            csv_file = os.path.join(_BASE_DIR, f"test/bench_apex_q_{kv_tag}_ub{ub}.csv")
