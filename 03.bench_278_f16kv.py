#!/usr/bin/env python3
"""03.bench_278_f16kv.py — 27B Dense Q8 F16 KV full context benchmark.

Tests 278 (27B Dense Q8) at p128/p4K/p32K/p64K/p128K/p256K.
F16 KV cache, UB=256. Note: p256K may timeout (>7200s).

Usage (on inference machine):
    LLM_BASE_DIR=/home/zxw LLM_API_KEY=xxx python3 -u 03.bench_278_f16kv.py
"""
...
CSV_FILE = os.path.join(_BASE_DIR, "test/bench_278_f16kv.csv")
