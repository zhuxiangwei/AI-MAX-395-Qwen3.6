...
| 256K tokens | *待测* | *待测* | *待测* |

> **已从活跃名单移除。** Gen 速度仅 11–13 t/s（Q6 ~17 t/s，Q4 ~21 t/s）；Q8_0 KV 改善长上下文 prefill（p128K +132%）但 gen 仍仅 ~9.5 t/s。256K：F16 KV Vulkan 崩溃，Q8_0 KV 待测。建议使用 Q6 或 Q4。
