#!/usr/bin/env python3
"""01.bench_358_f16kv.py — 35B MoE Q8 F16 KV full context benchmark.

Tests 358 (35B-A3B Q8 MoE) at p128/p4K/p32K/p64K/p128K/p256K.
F16 KV cache, UB=256.

Usage (on inference machine):
    LLM_BASE_DIR=/home/zxw LLM_API_KEY=xxx python3 -u 01.bench_358_f16kv.py
"""
...
# Add script directory to path for benchlib
...
CSV_FILE = os.path.join(_BASE_DIR, "test/bench_358_f16kv.csv")
...
def main():
    print("=" * 64)
    print("  35B MoE Q8 — F16 KV Full Context Benchmark")
    ...
    # Disable router service and kill any existing processes
