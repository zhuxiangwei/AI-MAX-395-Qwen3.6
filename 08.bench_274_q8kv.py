#!/usr/bin/env python3
"""08.bench_274_q8kv.py — 27B Dense Q4 Q8_0 KV + UB sweep benchmark.

Tests 274 (27B Dense Q4) with Q8_0 KV cache across UB values.

Usage (on inference machine):
    LLM_BASE_DIR=/home/zxw LLM_API_KEY=xxx python3 -u 08.bench_274_q8kv.py
"""
...
def main():
    print("=" * 64)
    print("  27B Dense Q4 — Q8_0 KV + UB Sweep Benchmark")
    ...
    try:
        for ub in UB_VALUES:
            csv_file = os.path.join(_BASE_DIR, f"test/bench_274_q8kv_ub{ub}.csv")
            results = []
    ...
    print(f"\n{'=' * 80}")
    print("  27B Dense Q4 Q8_0 KV — Combined Summary")
    print(f"{'=' * 80}")
